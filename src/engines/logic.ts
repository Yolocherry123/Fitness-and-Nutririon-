...
export function suggestCalorieGapTool(): string {
  return 'Try ONE practical addition first: banana, sattu drink, roasted peanuts/nuts, peanut butter, milk/milk powder, PB sandwich, oats, or a small amount of ghee.'
}
